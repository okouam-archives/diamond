  ...
  <li class="parent-sub"><a href="<?php echo get_permalink($post->post_parent) ?>"><?php echo $parent_title;?></a></li>
    ...
    <?php } }?>
     ...
     <?php $properties = getLatestBuyProperties(); ?>
      				...
      				<li class="media">
      				 <a href="/index.php/property?id=<?php echo $properties[0]->id ?>" class="content"><img class="img" src="<?= $properties[0]->image ?>" /></a>
      				...
      				<li class="media">
      				  <a href="/index.php/property?id=<?php echo $properties[1]->id ?>" class="content"><img class="img" src="<?= $properties[1]->image ?>" /></a>
      				  <div class="media-text">
